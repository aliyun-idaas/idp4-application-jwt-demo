...
import com.idsmanager.main.service.dto.AbstractOauthDto;
import com.idsmanager.main.infrastructure.json.JsonUtils;
...
public abstract class AbstractResponseHandler<T extends AbstractOauthDto> implements HttpResponseHandler {
    ...
    protected T responseToDto(IDSHttpResponse response, T dto) {
    ...
    protected T responseToErrorDto(IDSHttpResponse response, T dto) {
    ...
    protected T parseErrorXML(IDSHttpResponse response, T obj) {
        try {
